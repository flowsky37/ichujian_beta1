 ...
 */
package com.net.mokey.activity.net;
...
class HCKHttpRequest implements Runnable {
	...
	public HCKHttpRequest(AbstractHttpClient client, HttpContext context,
			HttpUriRequest request, HCKHttpResponseHandler responseHandler,
			String url) {
		this.client = client;
