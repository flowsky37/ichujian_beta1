...
import com.net.mokey.activity.LaunchActivity;
import com.net.mokey.activity.ShowCodeActivity;
import com.net.mokey.application.MoKeyApplication;
import com.net.mokey.zxing.camera.CameraManager;
import com.net.mokey.zxing.decoding.CaptureActivityHandler;
import com.net.mokey.zxing.decoding.InactivityTimer;
import com.net.mokey.zxing.view.ViewfinderView;
...
public class MipcaActivityCapture extends Activity implements Callback {
	...
	static MipcaActivityCapture activity;
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			...
			Intent resultIntent = new Intent(this,ShowCodeActivity.class);
